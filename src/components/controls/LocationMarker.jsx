    ...
    <Group2925 style={markerStyle}>
      <OverlapGroup>
        ...
        <Frame2730>
          ...
          <Polygon1 src="https://cdn.animaapp.com/projects/6183b51d6b5cbed22d564e6f/releases/61850ffff59ce59ffa02723a/img/polygon-1@2x.svg" />
          {isUsePhoto && (
            <MarkerImageWrap>
...
export const LocationMarkerNoPhoto = (props) => {
...
export const LocationMarkerNoCity = (props) => {
  const {
    markerImageSrc,
    locationText,
    longitude,
