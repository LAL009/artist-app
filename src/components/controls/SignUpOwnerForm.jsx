...
import ControlledInputRadioGroup from 'src/components/controls/ControlledInputRadioGroup';
...
const validationSchema = Yup.object().shape({
  ...
  address: Yup.string().nullable().required('Address is required field.'),
});

const SignUpOwnerForm = (props) => {
  return (
    <Formik
    ...
    >
      {({ validateForm, values, handleSubmit }) => {
        return (
          <Grid item xs={12}>
