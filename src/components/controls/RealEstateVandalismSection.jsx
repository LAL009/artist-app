    ...
    >
      ...
      >
        ...
        >
          ...
          <CardMedia
            component="img"
            image={`${process.env.REACT_APP_S3_BASE_URL}/assets/placeholders/sherwin-williams-logo.png`}
            sx={{
              width: '64.57px',
              margin: '0 auto',
              marginBottom: '32px',
        ...
        >
          ...
          <CardMedia
            component="img"
            image={`${process.env.REACT_APP_S3_BASE_URL}/assets/placeholders/nanoslic-logo.png`}
            sx={{
              width: '210.70px',
              margin: '0 auto',
              marginTop: '15px',
