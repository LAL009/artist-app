...
import { FacebookLoginIcon, GoogleLoginIcon } from 'src/components/icons';
...
export const SignInForm = () => {
  ...
  const onSubmit = (values, { setSubmitting }) => {
    dispatch(
      signIn(values.email, values.password, (redirect) => {
        setSubmitting(false);
        ...
        {({ handleSubmit }) => (
          <Form>
            ...
            >
              ...
              />
              <div style={{ zIndex: 1 }}>
                <NavLink to="/forgot-password" className={styles.label}>
                  Forgot password
                </NavLink>
              </div>
            </div>
