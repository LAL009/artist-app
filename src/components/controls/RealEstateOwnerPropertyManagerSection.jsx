        ...
        <Grid container justifyContent="center" spacing={2} direction="column">
          ...
          <Grid item xs={12}>
            ...
            >
              <Box>
                <img
                  ...
                  src={`${process.env.REACT_APP_S3_BASE_URL}/assets/home/checkmark.png`}
                  alt="Checkmark"
                />
              </Box>
            ...
            >
              ...
              >
                <p className={classes.lead}>Insurance & Legalities </p>
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={2} direction="row">
          ...
          <Grid item md={4} lg={4} xl={4}>
            ...
            >
              <img
                src={`${process.env.REACT_APP_S3_BASE_URL}/assets/home/verified-badge.png`}
                alt="Verified Badge"
              />
            </Box>
          </Grid>
