...
const FeaturedImagesSection = ({
  ...
  const longitude = _.get(coordinates, [0], 0);
  const latitude = _.get(coordinates, [1], 0);
  return (
    <Container maxWidth="xl">
      <Grid container spacing={{ xs: 2, sm: 3, md: 4, lg: 4, xl: 4 }}>
        <Grid item xs={12} sm={8} md={8}>
          <FeaturedSliderCard image={featureImage} createdAt={createdAt} />
        </Grid>
