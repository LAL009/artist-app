...
export const ArtistStatusButton = (props) => {
  const { isReady } = props;
  ...
  if (isReady) {
    return (
      <Frame281>
        <Ellipse111>
          <Ellipse112
            src={`${process.env.REACT_APP_S3_BASE_URL}/assets/available-icon.svg`}
          />
        </Ellipse111>
  ...
  if (!isReady) {
    return (
      <Frame281>
        <Ellipse111>
          <Ellipse112
            src={`${process.env.REACT_APP_S3_BASE_URL}/assets/busy-icon.svg`}
          />
        </Ellipse111>
