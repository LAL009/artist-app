    ...
    >
      ...
      >
        ...
        >
          <CardMedia
            component="img"
            image={`${process.env.REACT_APP_S3_BASE_URL}/assets/real-estate-analytics.png`}
            sx={{
              width: '100%',
            }}
          />
      ...
      >
        ...
        >
          <CardMedia
            component="img"
            image="https://cdn.animaapp.com/projects/6183b51d6b5cbed22d564e6f/releases/61937c34133415cdf03ef729/img/vector@2x.svg"
            sx={{
              width: '26px',
              flex: '0 1 auto',
            }}
