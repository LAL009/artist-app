...
export const ArtistProfileMenu = () => {
    ...
    <Root>
      {
        data.map((item) => (
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Arrow
              src="https://anima-uploads.s3.amazonaws.com/projects/6183b50129320a0a5485eeaf/releases/6183f96c02337c8be68c1f55/img/frame@2x.svg"
            />
          </Box>
        ))
      }
