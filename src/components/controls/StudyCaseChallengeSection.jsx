    ...
    >
      ...
      >
        ...
        >
          <CardMedia
            component="img"
            image="https://cdn.animaapp.com/projects/6183b51d6b5cbed22d564e6f/releases/618fb703a708f1031491850f/img/vector-3@2x.svg"
            sx={{
              maxWidth: '210px',
              height: 'auto',
            }}
      ...
      >
        ...
        {developerThumbnail && (
          ...
          >
            <CardMedia
              component="img"
              image={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/rectangle-119-2x.svg`}
              sx={{
                width: '100%',
                height: '80.54px',
            ...
            <CardMedia
              component="img"
              image={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/rectangle-118-1-2x.svg`}
              sx={{
                width: '100%',
                height: '80.54px',
                marginTop: '-75.54px',
