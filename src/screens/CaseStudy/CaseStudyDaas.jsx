    ...
    <>
      ...
      >
        <StudyCaseHeadingSection
          ...
          organization1ImageSrc={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/stillwater-logo.png`}
          organization2ImageSrc={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/DAAS-white-logo.png`}
        />
      </Box>
      ...
      >
        <StudyCaseSourcingSection
          ...
          sourcingThumbnail={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/DAAS-artist-in-action-3.jpg`}
          solutionVideo={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/DAAS-video-case-study.mov`}
        />
      </Box>
    </>
  );
