...
import StudyCaseOpenDateSection from 'src/components/controls/StudyCaseOpenDateSection';
    ...
    <>
      ...
      >
        <StudyCaseHeadingSection
          ...
          backgroundImageSrc={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/standard-coffee-shop.jpg`}
          organization1ImageSrc={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/standard-bean-logo.png`}
          organization2ImageSrc={`${process.env.REACT_APP_S3_BASE_URL}/assets/placeholders/cappelli.png`}
        />
      </Box>
      ...
      >
        <StudyCaseChallengeSection
          ...
          //developerThumbnail={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/DAAS-mockup.jpg`}
          longitude={-73.781213}
          latitude={40.911547}
        />
      </Box>
      ...
      >
        <StudyCaseOpenDateSection
          thumbnailImageSrc={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/standard-bean-quote.png`}
      ...
      >
        <StudyCaseSourcingSection
          ...
          sourcingThumbnail={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/standard-sourcing-artist.png`}
          solutionImage={`${process.env.REACT_APP_S3_BASE_URL}/assets/case-study/standard-bean-solution.png`}
        />
      </Box>
    </>
  );
